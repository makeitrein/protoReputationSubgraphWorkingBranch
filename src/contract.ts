...
export function handleApprovalForAll(event: ApprovalForAll): void {
  let eventType = getOrCreateEventType("ApprovalForAll")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleClaimableStateChanged(
  event: ClaimableStateChanged
): void {
  let eventType = getOrCreateEventType("ClaimableStateChanged")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleContributorsClaimStart(
  event: ContributorsClaimStart
): void {
  let eventType = getOrCreateEventType("ContributorsClaimStart")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleContributorsClaimStop(
  event: ContributorsClaimStop
): void {
  let eventType = getOrCreateEventType("ContributorsClaimStop")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleLandPublicSaleStart(event: LandPublicSaleStart): void {
  let eventType = getOrCreateEventType("LandPublicSaleStart")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleLandPublicSaleStop(event: LandPublicSaleStop): void {
  let eventType = getOrCreateEventType("LandPublicSaleStop")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}
...
export function handlePublicSaleMint(event: PublicSaleMint): void {
  let eventType = getOrCreateEventType("PublicSaleMint")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleStartingIndexSetAlphaBeta(
  event: StartingIndexSetAlphaBeta
): void {
  let eventType = getOrCreateEventType("StartingIndexSetAlphaBeta")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}

export function handleStartingIndexSetPublicSale(
  event: StartingIndexSetPublicSale
): void {
  let eventType = getOrCreateEventType("StartingIndexSetPublicSale")
  let baseMetric = getOrCreateBaseMetric(event, eventType)
}
